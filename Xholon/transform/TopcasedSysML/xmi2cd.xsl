...
<!--
	Transform SysML to ClassDetails.xml
	Author: Ken Webb
	Date:   August 16, 2007
	File:   xmi2cd.xsl
...
<xsl:variable name="portImplementation">
	<xsl:choose>
		<xsl:when test="$useIPorts='usemodeldefault'">
			<xsl:value-of select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Artifact'][@name='XholonModel']/ownedAttribute[@name='portImplementation']/defaultValue/@value"/>
		</xsl:when>
...
<xsl:template match="sysML:ModelSYSML">
	...
	<xsl:for-each select="/sysML:ModelSYSML//packagedElement[@xmi:type='sysML:Block']">
		<xsl:choose>
	...
	<!--<xsl:if test="/sysML:ModelSYSML//packagedElement[@name='StateMachineEntity']">-->
		<!-- States -->
		<xsl:element name="State">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:State']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateInitial">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='initial']"/>
			 <xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][not(@kind)]"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateChoice">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='choice']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateJunction">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='junction']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateFork">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='fork']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateJoin">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='join']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateShallowHistory">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='shallowHistory']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateDeepHistory">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//subvertex[@xmi:type='uml:Pseudostate'][@kind='deepHistory']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateEntryPoint">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//connectionPoint[@kind='entryPoint']"/>
		</xsl:element>
		...
		<xsl:element name="PseudostateExitPoint">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//connectionPoint[@kind='exitPoint']"/>
		</xsl:element>
		...
		<xsl:element name="TransitionExternal">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//transition[@kind='external']"/>
			<xsl:apply-templates select="/sysML:ModelSYSML//transition[not(@kind)]"/>
		</xsl:element>
		...
		<xsl:element name="TransitionLocal">
			...
			<xsl:apply-templates select="/sysML:ModelSYSML//transition[@kind='local']"/>
		</xsl:element>
...
<xsl:template match="ownedAttribute[@xmi:type='uml:Port'][@isBehavior='true']">
	...
	<!--<xsl:value-of select="count(/sysML:ModelSYSML//ownedConnector/end[@role=current()/@xmi:id]/@xmi:id)"/>--> <!-- debug -->
	<!--<xsl:message terminate="no">
		<xsl:text>ownedPort: </xsl:text>
		<xsl:value-of select="@name"/>
	</xsl:message>-->
	<xsl:choose>
		<xsl:when test="/sysML:ModelSYSML//ownedConnector/end[@role=current()/@xmi:id]/@xmi:id">
			<xsl:for-each select="/sysML:ModelSYSML//ownedConnector/end[@role=current()/@xmi:id]/@xmi:id">
				...
				<xsl:element name="port">
					...
					<xsl:attribute name="index">
						<xsl:value-of select="/sysML:ModelSYSML//packagedElement[$portClass=@xmi:id]/@name"/>
					</xsl:attribute>
					<xsl:choose>
						...
						<xsl:when test="$portImplementation='iport'">
							...
							<xsl:attribute name="providedInterface"> <!-- Realized Interface -->
								<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[$portClass=@xmi:id]/interfaceRealization"/>
							</xsl:attribute>
							<xsl:attribute name="requiredInterface">
								<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Usage'][$portClass=@client]"/>
							</xsl:attribute>
							<xsl:element name="portReplication">
								...
								<xsl:attribute name="connector">
									...
									<xsl:if test="count(/sysML:ModelSYSML//ownedConnector/end[@role=$portInstance/@xmi:id]) > 1"> <!-- Topcased -->
										<!--<xsl:text>b</xsl:text>--> <!-- debug -->
										<xsl:variable name="partWithPortAmb" select="/sysML:ModelSYSML//end[current()=@xmi:id]/@partWithPort"/>
									...
									<xsl:choose>
										<xsl:when test="$portInstance/@visibility='protected'"> <!-- Topcased -->
											...
											<xsl:apply-templates select="/sysML:ModelSYSML//end[current()=@xmi:id]/../end[current()!=@xmi:id]">
										...
										<xsl:otherwise>
											...
											<!--<xsl:value-of select="count(/sysML:ModelSYSML//end[$endref=@xmi:id]/../end[$endref!=@xmi:id])"/>--> <!-- debug -->
											<!--<xsl:if test="count(/sysML:ModelSYSML//end[$endref=@xmi:id]/../end[$endref!=@xmi:id]) > 1">--> <!-- debug -->
												<!--<xsl:value-of select="$endref"/>
												<xsl:for-each select="/sysML:ModelSYSML//end['_11_5_52bb0822_1158955957583_89846_552'=@xmi:id]/../end['_11_5_52bb0822_1158955957583_89846_552'!=@xmi:id]">
													<xsl:text>[[[</xsl:text>
	...
	<xsl:element name="port">
		...
		<xsl:choose>
			<xsl:when test="$portImplementation='iport'">
				...
				<xsl:attribute name="requiredInterface">
					<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Usage']/client[$portClass=@xmi:idref]"/>
				</xsl:attribute>
				<xsl:element name="portReplication">
					<xsl:attribute name="name">
						<xsl:text>replication</xsl:text>
					...
					<xsl:attribute name="connector">
						...
						<!-- Output roleName at start of XPath expression if there is a chance of ambiguity -->
						<xsl:if test="count(/sysML:ModelSYSML//ownedConnector/end[@role=@xmi:id]) > 1"> <!-- Topcased ??? -->
							<xsl:text>COUNT2</xsl:text> <!-- debug -->
							<xsl:variable name="partWithPortAmb" select="/sysML:ModelSYSML//end[$endref=@xmi:id]/@partWithPort"/>
							<xsl:variable name="roleNameAmb" select="$partWithPortAmb/../../../ownedAttribute[$partWithPortAmb=@xmi:id]/@name"/>
							<xsl:text>.[@roleName='</xsl:text>
							<xsl:value-of select="$roleNameAmb"/>
							<xsl:text>']/</xsl:text>
						...
						<xsl:choose>
							<xsl:when test="../@visibility='protected'">
								...
								<!-- an internal port, connected to behavior and to an internal part -->
								<!-- select opposite end of connector leading out from this port -->
								<xsl:apply-templates select="/sysML:ModelSYSML//end[$endref=@xmi:id]/../end[$endref!=@xmi:id]">
									<xsl:with-param name="seekingCommonAncestor">
										<xsl:text>false</xsl:text>
									</xsl:with-param>
									<xsl:with-param name="isStartOfChain">
...
<xsl:template match="end">
	...
	<xsl:variable name="myPortTypeId" select="/sysML:ModelSYSML//ownedAttribute[@xmi:type='uml:Port'][@xmi:id=current()/@role][@isBehavior='true']/@type"/>
	...
	<xsl:choose> <!-- an end is the context object at this point -->
		<!-- <xsl:when test="../@kind='assembly'">
			Topcased SysML doesn't use kind='assembly'; this must be the default? -->
		<xsl:when test="not(../@kind)">
			<xsl:text>ancestor::</xsl:text>
			
			<!-- the ownedConnector in the SysML model is under one of the connected blocks,
				rather than under a block that's higher up in the composite structure hierarchy -->
			<!--<xsl:value-of select="../../@name"/>-->
			<xsl:variable name="startEndzBlock" select="../../@xmi:id"/>
			<xsl:value-of select="/sysML:ModelSYSML//packagedElement/ownedAttribute[@type=$startEndzBlock]/../@name"/>
			...
			<xsl:choose>
				<xsl:when test="$myPortTypeId"> <!-- end of chain -->
					<xsl:value-of select="//ownedAttribute[@xmi:id=current()/@role]/../@name"/> <!-- debug -->
				...
				<xsl:otherwise>
					...
					<xsl:variable name="oPort" select="/sysML:ModelSYSML//ownedAttribute[@xmi:type='uml:Port'][@xmi:id=current()/@role]"></xsl:variable>
					<!--<xsl:value-of select="$oPort/@name"/>--> <!-- debug -->
					
					<xsl:choose>
						<xsl:when test="count(/sysML:ModelSYSML//ownedConnector/end[@role=$oPort/@xmi:id]) > 2"> <!-- Topcased -->
							...
							<xsl:for-each select="/sysML:ModelSYSML//ownedConnector[@kind='delegation']/end[@role=$oPort/@xmi:id]"> <!-- Topcased -->
						...
						<xsl:otherwise>
							...
							<!--<xsl:value-of select="/sysML:ModelSYSML//end[@role=$oPort/@xmi:id][$endref!=@xmi:id]/@xmi:id"/>--> <!-- debug -->
							<xsl:apply-templates select="$oPort">
								<xsl:with-param name="seekingCommonAncestor">
									<xsl:text>false</xsl:text>
								</xsl:with-param>
								...
								<xsl:with-param name="endref">
									<xsl:value-of select="/sysML:ModelSYSML//end[@role=$oPort/@xmi:id][$endref!=@xmi:id]/@xmi:id"/>
									<!--<xsl:value-of select="/sysML:ModelSYSML//end[$endref=@xmi:id]/../end[$endref!=@xmi:id]/@xmi:id"/>-->
								</xsl:with-param>
							</xsl:apply-templates>							
						</xsl:otherwise>
					</xsl:choose>
		...
		<xsl:otherwise> <!-- kind='delegation' -->
			...
			<xsl:choose>
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							...
							<xsl:apply-templates select="$oPort">
								...
								<xsl:with-param name="endref">
									<!--<xsl:value-of select="/sysML:ModelSYSML//end[$endref=@xmi:idref]/../end[$endref!=@xmi:idref]/@xmi:idref"/> MagicDraw-->
									<xsl:value-of select="/sysML:ModelSYSML//end[@role=$oPort/@xmi:id][$endref!=@xmi:id]/@xmi:id"/> <!-- Topcased -->
								</xsl:with-param>
							</xsl:apply-templates>
						</xsl:otherwise>
					</xsl:choose>
				...
				<xsl:otherwise> <!-- $seekingCommonAncestor='true' -->
					...
					<xsl:choose>
						<xsl:when test="/sysML:ModelSYSML//ownedAttribute[@xmi:type='uml:Port'][@xmi:id=current()/@role]/@isBehavior=true()"> <!-- end of chain -->
							<xsl:text>A</xsl:text> <!-- debug -->
							<!--<xsl:message terminate="no">
								<xsl:text>A</xsl:text>
							</xsl:message>-->
							<xsl:for-each select="/sysML:ModelSYSML//ownedAttribute[@xmi:type='uml:Port'][@xmi:id=current()/@role][@isBehavior=true()]">
								<xsl:text>ancestor::</xsl:text>
								<xsl:value-of select="../@name"/>
							</xsl:for-each>
						</xsl:when>
...
<xsl:template match="interfaceRealization">
	...
	<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Interface'][@xmi:id=$supplierId]"/>
</xsl:template>
...
<xsl:template match="packagedElement[@xmi:type='uml:Interface']">
	<xsl:for-each select="ownedAttribute">
		...
		<xsl:value-of select="/sysML:ModelSYSML//packagedElement[@xmi:id=$signalId]/@name"/>
		<xsl:text>,</xsl:text>
	</xsl:for-each>
</xsl:template>
...
<xsl:template match="subvertex">
	<xsl:for-each select="/sysML:ModelSYSML//transition[@source=current()/@xmi:id]/@source">
		<xsl:element name="port">
			<xsl:attribute name="name">
...
<xsl:template match="transition">
	...
	<xsl:param name="targetType" select="/sysML:ModelSYSML//subvertex[@xmi:id=$targetRef]/@xmi:type
		| /sysML:ModelSYSML//connectionPoint[@xmi:id=$targetRef]/@xmi:type
		| /sysML:ModelSYSML//connection[@xmi:id=$targetRef]/@xmi:type"/>
	<xsl:param name="targetKind" select="/sysML:ModelSYSML//subvertex[@xmi:id=$targetRef]/@kind
		| /sysML:ModelSYSML//connectionPoint[@xmi:id=$targetRef]/@kind"/>
		...
		<xsl:attribute name="connector">
			...
			<xsl:choose>
				...
				<xsl:when test="not($targetType) and not($targetKind)">
					...
					<xsl:variable name="connection" select="/sysML:ModelSYSML//connection[@xmi:id=$targetRef]"/>
					<xsl:if test="$connection">
						<xsl:variable name="connectionConnPt" select="/sysML:ModelSYSML//connectionPoint[@xmi:id=$connection/@entry]"/>
						<xsl:choose>
			...
			<xsl:choose>
				<xsl:when test="$targetType='uml:ConnectionPointReference'">
					...
					<xsl:variable name="entryPointTargetId" select="/sysML:ModelSYSML//connectionPoint[@xmi:id=$connectionEntryId]/@xmi:id"/>
					<xsl:call-template name="outputUniqueId">
...
<xsl:template name="outputPortzOwningClass">
	...
	<!--<xsl:message terminate="no">
		<xsl:value-of select="/sysML:ModelSYSML//packagedElement[@xmi:id=$classId]/@name"/>
	</xsl:message>-->
	<xsl:value-of select="/sysML:ModelSYSML//packagedElement[@xmi:id=$classId]/@name"/> <!-- output the class name -->
...
<xsl:template name="outputPortAndReplication">
	...
	<xsl:variable name="myDefaultValue" select="/sysML:ModelSYSML//packagedElement[@xmi:id=$portTypeId]/ownedAttribute/defaultValue"/>
	<xsl:choose>
