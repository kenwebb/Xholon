...
<xsl:template match="sysML:ModelSYSML">
	...
	<params>
		...
		<xsl:call-template name="ownedMember">
			...
			<xsl:with-param name="paramDefaultValue">
				<xsl:text>org.primordion.xholon.xmiappsTcSysML.App</xsl:text>
				<xsl:value-of select="@name"/>
			</xsl:with-param>
		</xsl:call-template>		
		<xsl:call-template name="ownedMember">
			...
			<xsl:with-param name="paramDefaultValue">
				<xsl:text>org.primordion.xholon.xmiappsTcSysML.Xh</xsl:text>
				<xsl:value-of select="@name"/>
			</xsl:with-param>
		</xsl:call-template>		
		...
		<xsl:for-each select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute">
			<xsl:choose>
...
<xsl:template name="ownedMember">
	...
	<xsl:element name="param">
		...
		<xsl:attribute name="value">
			<xsl:choose>
				<xsl:when test="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute[@name=$paramName]">
					<!-- xalan-j crashes if I use $xhnParams in the following statement -->
					<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute[@name=$paramName]">
