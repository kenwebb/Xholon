...
<!--
	Transform SysML  to Xh<appName>.java file
	Author: Ken Webb
	Date:   August 16, 2007
	File:   xmi2jx.xsl
...
<xsl:template match="sysML:ModelSYSML">
	...
	<xsl:for-each select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][../@name='XholonBaseClasses']">
	...
	<xsl:for-each select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][@clientDependency or generalization/general/@href='pathmap://UML_METAMODELS/UML.metamodel.uml#Port']">  <!-- ??? TOPCASED -->
	...
	<xsl:value-of select="count(/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][generalization/general/xmi:Extension/referenceExtension[@referentPath='UML Standard Profile::UML2.0 Metamodel::CompositeStructures::Ports::Port']])"/>
	<xsl:text>;&#10;&#10;</xsl:text>
	-->
	<xsl:text>&#10;</xsl:text>
	...
	<xsl:apply-templates select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Signal']"/>
	<xsl:text>&#10;</xsl:text>
	
	<!-- variables -->
	<xsl:text>// Variables&#10;</xsl:text>
	<xsl:text>public String roleName = null;&#10;</xsl:text>
	<xsl:apply-templates select="/sysML:ModelSYSML//ownedAttribute[@name]"/>
	<xsl:text>&#10;</xsl:text>
	...
	<xsl:for-each select="/sysML:ModelSYSML//ownedAttribute[@name]">
	...
	<xsl:for-each select="/sysML:ModelSYSML//ownedOperation[not(../@isAbstract='true')]">
	...
	<!-- preConfigure -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='preConfigure'][not(@isAbstract='true')]">
		<xsl:text>public void preConfigure()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='preConfigure']"/>
		<xsl:text>	default:&#10;</xsl:text>
		<xsl:text>		break;&#10;</xsl:text>
		<xsl:text>	}&#10;</xsl:text>
	...
	<!-- configure -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='configure'][not(@isAbstract='true')]">
		<xsl:text>public void configure()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='configure']"/>
		<xsl:text>	default:&#10;</xsl:text>
		<xsl:text>		break;&#10;</xsl:text>
		<xsl:text>	}&#10;</xsl:text>
	...
	<!-- postConfigure -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='postConfigure'][not(@isAbstract='true')]">
		<xsl:text>public void postConfigure()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='postConfigure']"/>
		<xsl:text>	default:&#10;</xsl:text>
		<xsl:text>		break;&#10;</xsl:text>
		<xsl:text>	}&#10;</xsl:text>
	...
	<!-- preAct -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='preAct'][not(@isAbstract='true')]">
		<xsl:text>public void preAct()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='preAct']"/>
		<xsl:text>	default:&#10;</xsl:text>
		<xsl:text>		break;&#10;</xsl:text>
		<xsl:text>	}&#10;</xsl:text>
	...
	<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='act']"/>
	
	<xsl:for-each select="/sysML:ModelSYSML//packagedElement[@xmi:type='uml:Class'][ownedBehavior//doActivity]">
	...
	<!-- postAct -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='postAct'][not(@isAbstract='true')]">
		<xsl:text>public void postAct()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='postAct']"/>
		<xsl:text>	default:&#10;</xsl:text>
		<xsl:text>		break;&#10;</xsl:text>
		<xsl:text>	}&#10;</xsl:text>
	...
	<xsl:apply-templates select="/sysML:ModelSYSML//effect[@xmi:type='uml:OpaqueBehavior']"/>
	<xsl:apply-templates select="/sysML:ModelSYSML//entry[@xmi:type='uml:OpaqueBehavior']"/>
	<xsl:apply-templates select="/sysML:ModelSYSML//exit[@xmi:type='uml:OpaqueBehavior']"/>
	<xsl:for-each select="/sysML:ModelSYSML//doActivity[@xmi:type='uml:OpaqueBehavior']">
		<xsl:text>&#9;case </xsl:text>
	...
	<xsl:text>&#9;default:&#10;</xsl:text>
	<xsl:text>&#9;&#9;System.out.println("Xh</xsl:text>
	<xsl:value-of select="/sysML:ModelSYSML/@name"/>
	...
	<xsl:text>{&#10;</xsl:text>
	<xsl:text>&#9;switch (activityId) {&#10;</xsl:text>
	<xsl:apply-templates select="/sysML:ModelSYSML//ownedRule[../@guard]"/>
	<xsl:text>&#9;default:&#10;</xsl:text>
	<xsl:text>&#9;&#9;System.out.println("Xh</xsl:text>
	<xsl:value-of select="/sysML:ModelSYSML/@name"/>
	...
	<!-- handleNodeSelection -->
	<xsl:if test="/sysML:ModelSYSML//ownedOperation[@name='handleNodeSelection'][not(@isAbstract='true')]">
		<xsl:text>public Object handleNodeSelection()&#10;</xsl:text>
		<xsl:text>{&#10;</xsl:text>
		<xsl:text>	switch(xhc.getId()) {&#10;</xsl:text>
		<xsl:apply-templates select="/sysML:ModelSYSML//ownedOperation[@name='handleNodeSelection']"/>
		<xsl:text>	default:&#10;</xsl:text>
...
<xsl:template match="packagedElement[@xmi:type='uml:Signal']">
	...
	<xsl:value-of select="/sysML:ModelSYSML//ownedAttribute[@type=$sigId]/defaultValue/@value"/>
	<xsl:value-of select="ownedAttribute/defaultValue/@body"/>
	<xsl:value-of select="/sysML:ModelSYSML//ownedAttribute[@type=$sigId]/defaultValue/@body"/>
	<xsl:text>;&#10;</xsl:text>
</xsl:template>
...
<xsl:template match="ownedAttribute">
	<xsl:if test="../@xmi:type='uml:Class' and not(@aggregation='composite')">
		...
		<xsl:variable name="javaType" select="concat(substring(type/@href, $jTypePosition), /sysML:ModelSYSML//packagedElement[@xmi:id=current()/@type]/@name)"/>
...
<xsl:template name="outputSignalName">
	...
	<xsl:param name="signalId" select="/sysML:ModelSYSML//packagedElement[@xmi:id=$signalEventId]/@signal"/>
