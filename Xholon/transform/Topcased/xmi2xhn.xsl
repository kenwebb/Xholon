...
<xsl:template match="uml:Model">
	<!--<xsl:param name="xhnParameters" select="//uml:Model//ownedMember[@xmi:type='uml:Class'][@name='XhnParams']"/>-->
	<xsl:comment>
		<xsl:text>&#10;&#9;</xsl:text>
	...
	<params>
		...
		<xsl:call-template name="ownedMember">
			...
			<xsl:with-param name="paramDefaultValue">
				<xsl:text>org.primordion.xholon.xmiappsTc.App</xsl:text>
				<xsl:value-of select="@name"/>
			</xsl:with-param>
		</xsl:call-template>		
		<xsl:call-template name="ownedMember">
			...
			<xsl:with-param name="paramDefaultValue">
				<xsl:text>org.primordion.xholon.xmiappsTc.Xh</xsl:text>
				<xsl:value-of select="@name"/>
			</xsl:with-param>
		</xsl:call-template>		
		...
		<xsl:for-each select="//uml:Model//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute">
			<xsl:choose>
				...
				<!-- these are common parameters not yet part of the XhnParams class -->
...
<xsl:template name="ownedMember">
	...
	<xsl:element name="param">
		...
		<xsl:attribute name="value">
			<xsl:choose>
				<xsl:when test="//uml:Model//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute[@name=$paramName]">
					<!-- xalan-j crashes if I use $xhnParams in the following statement -->
					<xsl:apply-templates select="//uml:Model//packagedElement[@xmi:type='uml:Class'][@name='XhnParams']/ownedAttribute[@name=$paramName]">
