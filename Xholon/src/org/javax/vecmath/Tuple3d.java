 ...
 */
    ...
    // Ken Webb added these getters as per the javadoc for a later version of javax.vecmath
    // see: https://download.java.net/media/java3d/javadoc/1.5.1/javax/vecmath/Tuple3d.html
    public final double getX() {return this.x;}
    public final double getY() {return this.y;}
    public final double getZ() {return this.z;}
    
    // Ken Webb added these setters
