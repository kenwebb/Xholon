...
//import java.awt.Graphics; // KSW commented out
//import java.awt.Graphics2D; // KSW commented out
//import java.text.DecimalFormat; // KSW commented out  compile error
import java.util.Vector;

//import javax.swing.JFrame; // KSW commented out
import org.javax.vecmath.Vector3d;

import org.bsim.draw.BSimDrawer;
import org.bsim.export.BSimExporter;
...
public class BSim {
	...
	//private DecimalFormat timeFormat = new DecimalFormat("0.00"); // KSW commented out  compile error
	...
	public void setTimeFormat(String s) {} // new DecimalFormat(s); } // KSW compile error
	...
	public String getFormattedTime() { return "FORMATTED TIME";} //timeFormat.format(timestep*dt); } // KSW compile error
	public String getFormattedTimeHours() { return "FORMATTED TIME HOURS";} //timeFormat.format(timestep*dt/3600.0); } // KSW compile error
	 ...
	 */
	public void preview() { // KSW commented out
		...
		this.consoleLog("preview() ...");
		timestep = 0;
		for (int i = 0; i < 100; i++) {
			this.consoleLog("stepping: " + timestep);
			ticker.tick();
			timestep++;
			drawer.draw(null);
			//frame.repaint();
