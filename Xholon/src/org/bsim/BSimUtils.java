...
import org.javax.vecmath.AxisAngle4d;
import org.javax.vecmath.Matrix3d;
...
public class BSimUtils {
	...
	public static synchronized String timeStamp(){
		...
		timestampStr = yyyyStr + "-" + mmStr + "-" + ddStr + "_" +
			hhStr + "-" + miStr + "-" + ssStr;
		*/
		return "DUMMY TIMESTAMP"; //timestampStr;
	}
