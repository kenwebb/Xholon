...
package org.bsim.geometry;

import java.util.ArrayList;
//import java.util.Hashtable; // KSW commented out
import java.util.HashMap; // KSW
...
public class BSimSphereMesh extends BSimMesh {
	 ...
	 */
	//private Hashtable<Long,Integer> midPointsCache; // KSW [ERROR] Line 31: No source code is available for type java.util.Hashtable<K,V>; GWT does NOT suport java.util.Hashtable
	private HashMap<Long,Integer> midPointsCache; // KSW
	...
	protected void createMesh() {
        ...
        for(int i = 0; i < this.recursionThreshold; i++){
        	...
        	//midPointsCache = new Hashtable<Long,Integer>(faces.size()*2,0.8f); // KSW
        	midPointsCache = new HashMap<Long,Integer>(faces.size()*2,0.8f); // KSW
