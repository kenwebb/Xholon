package org.bsim.examples.BSimBrownianMotion;
...
import org.bsim.BSimUtils;
import org.bsim.export.BSimConsoleLoggerJS;
...
public class BSimBrownianMotion {
	...
	public static void main(String[] args) {
		 ...
		 * Set up exporters
		 */
		sim.addExporter(new BSimConsoleLoggerJS(sim, resultsDir + "particleX" + System.currentTimeMillis() + ".csv") {
