...

{
	...
	//protected Color nodeColor = Color.blue; // KSW commented out
	...
	/*public Color getnodeColor() { // KSW commented out
	...
	/** Set the colour. */
	/*public void setColor(Color c) { // KSW commented out
		this.nodeColor = c;
	}*/
	 ...
	 */
	/*public void colorFromCentre(BSimOctreeField t) { // KSW commented out
	 ...
	 */
	/*public void colorFromConc() { // KSW commented out
