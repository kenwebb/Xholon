 ...
 * The resulting file can be read by Vanted.
...
public class Xholon2PnmlVanted extends Xholon2Pnml {
	
	/**
	 * constructor
	 */
	public Xholon2PnmlVanted() {
		super();
		this.setUseVantedSettings(true);
		this.setUseDocCheckSettings(false);
