...
/**
 * Export a GridPanel canvas in JPEG format.
 * @author <a href="mailto:ken@primordion.com">Ken Webb</a>
 * @see <a href="http://www.primordion.com/Xholon">Xholon Project website</a>
 * @since 0.9.0 (Created on January 2, 2014)
 */
@SuppressWarnings("serial")
public class Xholon2Jpeg4Canvas extends AbstractXholon2ExternalFormat implements IXholon2ExternalFormat {
  
  protected String outFileName;
  protected String outFileNameExt = ".jpg";
