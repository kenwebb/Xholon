...
public class Xholon2Graphviz extends AbstractXholon2ExternalFormat implements IXholon2ExternalFormat {
  ...
  */
  ...
  /**
   * Default Node fill color if shouldColor == true.
   */
  public native String getDefaultNodeColor() /*-{return this.efParams.defaultNodeColor;}-*/;
  //public native void setDefaultNodeColor(String defaultNodeColor) /*-{this.efParams.defaultNodeColor = defaultNodeColor;}-*/;

  /**
   * Graph fill color
   */
  public native String getBgGraphColor() /*-{return this.efParams.bgGraphColor;}-*/;
  //public native void setBgGraphColor(String bgGraphColor) /*-{this.efParams.bgGraphColor = bgGraphColor;}-*/;
