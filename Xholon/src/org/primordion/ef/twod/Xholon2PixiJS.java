...
public class Xholon2PixiJS extends AbstractXholon2ExternalFormat implements IXholon2GraphFormat {
  ...
  protected native void layoutKLayJson(IXholon root, int width, int height) /*-{
    $wnd.xh.xport("_other,KLayJson", root,
     '{"nameTemplate":"R^^^^^", "showEdges":true, "showPorts":true, "direction":"UNDEFINED", "edgeRouting":"ORTHOGONAL", "spacing":'
     + this.efParams.spacing
     + ', "width":'
     + width
     + ', "height":'
     + height
     + ', "nodeWidth":'
     + this.efParams.nodeWidth
     + ', "nodeHeight":'
     + this.efParams.nodeHeight
     + ', "portWidth":5, "portHeight":5, "selection":"#xhsvg", "maxChars":'
     + this.efParams.maxChars
     + ', "writeToTarget":true, "writeLayoutedToTarget":true, "display":false, "_jsdata":true, "showStateMachineEntities":'
     + this.efParams.shouldShowStateMachineEntities
     + '}');
  }-*/;
  ...
  public void writeNode(IXholon xhNode) {
    ...
    .append(xhNodeName).append(".beginFill(").append(((IDecoration)xhNode).getColor()).append(" || 0xF0F8FF, 0.1);\n")
  ...
  protected void writeStart() {
    ...
    //.append("renderer.backgroundColor = 0xFFFFFF;\n")
  ...
  public native boolean isShouldShowStateMachineEntities() /*-{
    return this.efParams.shouldShowStateMachineEntities;
  }-*/;
  ...
  public native String getLayouter() /*-{return this.efParams.layouter;}-*/;
  //public native void setLayouter(String layouter) /*-{this.efParams.layouter = layouter;}-*/;
