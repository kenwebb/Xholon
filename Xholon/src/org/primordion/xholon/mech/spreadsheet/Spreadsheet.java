...
<Spreadsheet roleName="CellModel">
  ...
  <Srw>
    <Scl roleName="Glucose2">
      <Sfr>=INT(XPATH/descendant::ExtraCellularSolution/Glucose/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Glucose8">
      <Sfr>=INT(XPATH/descendant::Cytosol/Glucose/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Glucose_6_Phosphate">
      <Sfr>=INT(XPATH/descendant::Cytosol/Glucose_6_Phosphate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Fructose_6_Phosphate">
      <Sfr>=INT(XPATH/descendant::Cytosol/Fructose_6_Phosphate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Fructose_1x6_Biphosphate">
      <Sfr>=INT(XPATH/descendant::Cytosol/Fructose_1x6_Biphosphate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="DihydroxyacetonePhosphate">
      <Sfr>=INT(XPATH/descendant::Cytosol/DihydroxyacetonePhosphate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Glyceraldehyde_3_Phosphate">
      <Sfr>=INT(XPATH/descendant::Cytosol/Glyceraldehyde_3_Phosphate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="X1x3_BisphosphoGlycerate">
      <Sfr>=INT(XPATH/descendant::Cytosol/X1x3_BisphosphoGlycerate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="X3_PhosphoGlycerate">
      <Sfr>=INT(XPATH/descendant::Cytosol/X3_PhosphoGlycerate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="X2_PhosphoGlycerate">
      <Sfr>=INT(XPATH/descendant::Cytosol/X2_PhosphoGlycerate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="PhosphoEnolPyruvate">
      <Sfr>=INT(XPATH/descendant::Cytosol/PhosphoEnolPyruvate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="Pyruvate">
      <Sfr>=INT(XPATH/descendant::Cytosol/Pyruvate/attribute::double)</Sfr>
    </Scl>
    <Scl roleName="SUM">
