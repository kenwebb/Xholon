 ...
 */
public class Condition extends Behavior_gwtjs implements IBehaviorTree {
  private static final long serialVersionUID = 0L;
  
  /**
   * The agent is also called an "ai entity". It's the owner of the Behavior Tree, the initial parent of RootBT node.
   * A Condition interacts directly with the agent, and does not know that it's a node in a Behavior Tree.
   */
   ...
   */
    ...
    if (bobj != null) {
      ...
      $wnd.console.log("ConditionBT bobj is null");
    }
	}-*/;
