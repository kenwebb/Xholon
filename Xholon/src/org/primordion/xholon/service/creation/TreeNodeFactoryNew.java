  ...
  protected native Object extraAttrs(IXholon node, IXholon rawNode, String ignoreChar) /*-{
    ...
    // io
		...
		// mech.catt
			...
			else if (implName.endsWith("CatOpDsl")) {
				newNode = new org.primordion.xholon.mech.catt.CatOpDsl();
			}
		}
		...
		// remember to add the script to the isClassFindable() method as well
			...
			else if (implName.endsWith("AnimateMulti")) {
				newNode = new org.primordion.xholon.script.AnimateMulti();
			}
        ...
        newNode = new org.primordion.xholon.service.svg.SvgAttribute();
			...
			else if (implName.endsWith("IndexedDBService")) {
				newNode = new org.primordion.xholon.service.IndexedDBService();
			}
			else if (implName.endsWith("WebCryptographyService")) {
				newNode = new org.primordion.xholon.service.WebCryptographyService();
			}
	  ...
	  /* GWT
		...
		if (implName.startsWith("org.primordion.xholon.script")) {
		  ...
		  if (implName.endsWith("Lojban")) {
			...
			if (implName.endsWith("AnimateMulti")) {
				return true;
			}
