...
*/
public class Appcarboncycle03 extends Application {

// Variables

public Appcarboncycle03() {super();}
...
public void initialize(String configFileName) throws XholonConfigurationException
{
	...
	if (getUseInteractions()) {
		...
		providedRequiredInterface.setInterface(Xhcarboncycle03.getSignalIDs());
		providedRequiredInterface.setInterfaceNames(Xhcarboncycle03.getSignalNames());
...
public static void main(String[] args) {
    appMain(args, "org.primordion.user.app.climatechange.carboncycle03.Appcarboncycle03",
        "/org/primordion/user/app/climatechange/carboncycle03/_xhn.xml");
}
