 ...
 * </p>
 */
public class Appigm extends Application {
	...
	public void initialize(String configFileName)
		...
		if (getUseInteractions()) {
			// include complete class name on sequence diagrams, rather than
			...
			providedRequiredInterface.setInterface(Xhigm.getSignalIDs());
			providedRequiredInterface.setInterfaceNames(Xhigm.getSignalNames());
	...
	protected void step() {
		...
		if (getUseGridViewer()) {
			for (int vIx = 0; vIx < gridViewers.size(); vIx++) {
				GridViewerDetails gvd = (GridViewerDetails) gridViewers
						.get(vIx);
	...
	protected boolean shouldBePlotted(
			org.primordion.xholon.base.IXholon modelNode) {
  ...
  public Object findGwtClientBundle() {
	...
	public static void main(String[] args) {
		appMain(args, "org.primordion.user.app.climatechange.igm.Appigm",
				"/org/primordion/user/app/climatechange/igm/_xhn.xml");
	}
