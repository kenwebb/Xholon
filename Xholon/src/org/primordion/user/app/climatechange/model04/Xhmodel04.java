 ...
 * see: wikipedia Stefan–Boltzmann constant
 * "the total energy radiated per unit surface area of a black body in unit time
 * is proportional to the fourth power of the thermodynamic temperature"
 */
...
/*
  messages: fluxes (W m^-2)
    ...
    reflected solar radiation (from Atmosphere to Space)
    reflected solar radiation (from Surface to Space)
 ...
 * Reflected solar radiation from surface (from Surface to TopOfAtmosphere).
 */
...
/**
 * 2 types of energy flux: radiative flux, heat flux
 * wikipedia: Energy flux "Energy flux is the rate of transfer of energy through a surface."
 * Convert an energy flux in watts per square meter to a temperature in degrees Kelvin.
 * (390/.0000000567)pow0.25 --> 287.98°K (14.83°C)
 * @param wattsPerSquareMeter An energy flux in watts per square meter.
...
/**
 * Convert a temperature in degrees Kelvin to an energy flux in watts per square meter.
 * @param temperature A temperature in degrees Kelvin.
