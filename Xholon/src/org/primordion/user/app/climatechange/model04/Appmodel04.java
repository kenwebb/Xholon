...
// testing for GWT (I'm using AppGenerator instead)
/*public boolean setAppSpecificObjectVal(IXholon tNode, String attrName, IXholon val) {
  System.out.println("Appmodel04 setAppSpecificObjectVal( " + tNode + " " + attrName + " " + val);
  boolean rc = false;
  if (org.primordion.user.app.climatechange.model04.Sun.class == tNode.getClass()) {
    System.out.println("Appmodel04 setAppSpecificObjectVal( Sun");
    if ("space".equals(attrName)) {
      System.out.println("Appmodel04 setAppSpecificObjectVal( space");
      ((org.primordion.user.app.climatechange.model04.Sun)tNode).setSpace(val);
      rc = true;
    }
  }
  return rc;
...
public static void main(String[] args) {
    appMain(args, "org.primordion.user.app.climatechange.model04.Appmodel04",
        "/org/primordion/user/app/climatechange/model04/_xhn.xml");
}
