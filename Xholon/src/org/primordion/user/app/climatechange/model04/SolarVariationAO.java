 ...
 *
 */
public class SolarVariationAO extends Xhmodel04 {
	...
	private double solarConstantMultiplier = 1.002; //1.014;
	...
	public void act() {
		double solarConstant = ((Sun)star).getSolarConstant() * solarConstantMultiplier;
