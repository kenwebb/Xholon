...
*/
public class Xhsolarsystemtest extends XholonWithPorts implements Cesolarsystemtest {
...
// Constructor
public Xhsolarsystemtest() {super();}
...
{
  consoleLog("Xhsolarsystemtest.initialize( ");
	super.initialize();
}

public void postConfigure()
{
  consoleLog("Xhsolarsystemtest.postConfigure( " + this.toString());
	switch(xhc.getId()) {
	default:
		break;
	}
