 ...
 */
public class GridPanelStupidModel5 extends GridPanel implements IGridPanel, CeStupidModel5 {
	private static final long serialVersionUID = 1L;
	
	/**
	 * Constructor
	 */
	public GridPanelStupidModel5() {super();}
	
	/**
	 * Constructor
	 * @param gridOwner Xholon that owns the grid. */
	public GridPanelStupidModel5(IXholon gridOwner) {super(gridOwner);}
	...
	public CssColor getColor(IXholon xhNode)
	{
		...
		case BugCE:
			...
			int bugSizeRed = (int)((BugStupidModel5)xhNode).getBugSize();
