...
*/
public class BugStupidModel10 extends XhStupidModel10 implements Comparable {
	...
	public int compareTo(Object o) {
		...
		if (bugSize < ((BugStupidModel10)o).bugSize) {return 1;}
		else if (bugSize > ((BugStupidModel10)o).bugSize) {return -1;}
		return 0;
	}
