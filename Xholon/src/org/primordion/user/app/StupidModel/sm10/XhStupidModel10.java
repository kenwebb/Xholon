...
*/
public class XhStupidModel10 extends XholonWithPorts implements CeStupidModel10 {
		...
		case StupidModelCE:
			...
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel10 postConfigure() schedulingQ Q_FULL");
				}
