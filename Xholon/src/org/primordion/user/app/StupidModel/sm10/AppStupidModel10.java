...
*/
public class AppStupidModel10 extends Application {

	public AppStupidModel10() {super();}
	
	public double getMaxConsumptionRate() {return BugStupidModel10.maxConsumptionRate;}
	public double getMaxFoodProductionRate() {return HabitatCellStupidModel10.maxFoodProductionRate;}

	public void setMaxConsumptionRate(double maxConsumptionRate)
	{
		BugStupidModel10.maxConsumptionRate = maxConsumptionRate;
	}
	
	public void setMaxFoodProductionRate(double maxFoodProductionRate)
	{
		HabitatCellStupidModel10.maxFoodProductionRate = maxFoodProductionRate;
	}
	...
	protected void step()
	{
		...
		if (XhStupidModel10.isProcessingComplete()) {
			setControllerState(IControl.CS_STOPPED);
			System.out.println("Processing is complete");
			XhStupidModel10.setProcessingComplete(false); // reset in case this app is run again
	...
	{
		if (modelNode.getXhcId() == CeStupidModel10.AggregatorCE
	...
	public static void main(String[] args) {
	    appMain(args, "org.primordion.user.app.StupidModel.AppStupidModel10",
