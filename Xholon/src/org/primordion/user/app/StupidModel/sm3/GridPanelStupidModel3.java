 ...
 */
public class GridPanelStupidModel3 extends GridPanel implements IGridPanel, CeStupidModel3 {
	private static final long serialVersionUID = 1L;
	
	/**
	 * Constructor
	 */
	public GridPanelStupidModel3() {super();}
	
	/**
	 * Constructor
	 * @param gridOwner Xholon that owns the grid. */
	public GridPanelStupidModel3(IXholon gridOwner) {super(gridOwner);}
	...
	public CssColor getColor(IXholon xhNode)
	{
		...
		case BugCE:
			...
			int bugSizeRed = (int)((BugStupidModel3)xhNode).getBugSize();
