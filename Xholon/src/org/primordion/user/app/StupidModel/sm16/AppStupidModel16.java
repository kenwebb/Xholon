...
package org.primordion.user.app.StupidModel.sm16;
...
*/
public class AppStupidModel16 extends Application {

	public AppStupidModel16() {super();}
	
	public double getMaxConsumptionRate() {return BugStupidModel16.maxConsumptionRate;}
	//public double getMaxFoodProductionRate() {return HabitatCellStupidModel16.maxFoodProductionRate;}
	public double getSurvivalProbability() {return BugStupidModel16.survivalProbability;}
	public double getInitialBugSizeMean() {return BugStupidModel16.initialBugSizeMean;}
	public double getInitialBugSizeSD() {return BugStupidModel16.initialBugSizeSD;}
	public String getStupidCellData() {return HabitatCellStupidModel16.stupidCellData;}

	public void setMaxConsumptionRate(double maxConsumptionRate)
	{
		BugStupidModel16.maxConsumptionRate = maxConsumptionRate;
	}
	...
	{
		BugStupidModel16.survivalProbability = survivalProbability;
	}
	
	public void setInitialBugSizeMean(double initialBugSizeMean)
	{
		BugStupidModel16.initialBugSizeMean = initialBugSizeMean;
	}
	
	public void setInitialBugSizeSD(double initialBugSizeSD)
	{
		BugStupidModel16.initialBugSizeSD = initialBugSizeSD;
	}
	
	public void setStupidCellData(String stupidCellData)
	{
		HabitatCellStupidModel16.stupidCellData = stupidCellData;
	}
	...
	protected void step()
	{
		...
		if (XhStupidModel16.isProcessingComplete()) {
			setControllerState(IControl.CS_STOPPED);
			System.out.println("Processing is complete");
			XhStupidModel16.setProcessingComplete(false); // reset in case this app is run again
	...
	{
		if (modelNode.getXhcId() == CeStupidModel16.AggregatorCE
	...
	public static void main(String[] args) {
	    appMain(args, "org.primordion.user.app.StupidModel.AppStupidModel16",
