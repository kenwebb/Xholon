 ...
 */
public class GridPanelStupidModel12 extends GridPanel implements IGridPanel, CeStupidModel12 {
	private static final long serialVersionUID = 1L;
	
	/**
	 * Constructor
	 */
	public GridPanelStupidModel12() {super();}
	
	/**
	 * Constructor
	 * @param gridOwner Xholon that owns the grid. */
	public GridPanelStupidModel12(IXholon gridOwner) {super(gridOwner);}
	...
	public CssColor getColor(IXholon xhNode)
	{
		...
		case BugCE:
			...
			int bugSizeRed = (int)((BugStupidModel12)xhNode).getBugSize() * 25;
