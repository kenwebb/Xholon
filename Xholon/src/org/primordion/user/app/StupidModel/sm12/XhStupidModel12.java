...
*/
public class XhStupidModel12 extends XholonWithPorts implements CeStupidModel12 {
		...
		case StupidModelCE:
			...
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel12 postConfigure() schedulingQ Q_FULL");
				}
