...
*/
public class BugStupidModel12 extends XhStupidModel12 implements Comparable {
	...
	protected void move()
	{
		...
		Vector v = ((HabitatCellStupidModel12)parentNode).inRadius(4);
	...
	protected void reproduce()
	{
		...
		die();
		for (int i = 0; i < 5; i++) {
			BugStupidModel12 newBug = (BugStupidModel12)myParent.appendChild(myXhcName, null, myImplName);
	...
	public int compareTo(Object o) {
		...
		if (bugSize < ((BugStupidModel12)o).bugSize) {return 1;}
		else if (bugSize > ((BugStupidModel12)o).bugSize) {return -1;}
		return 0;
	}
