...
*/
public class QueueStupidModel15 extends Queue implements IQueue {
	...
	public void act()
	{
		...
		int sz = getSize();
		if (sz == 0) {
			XhStupidModel15.setProcessingComplete(true);
		}
		for (int i = 0; i < sz; i++) {
	...
	public void sendMessage(int signal, Object data, IXholon sender)
	{
		if (enqueue(sender) == Q_FULL) {
			System.out.println("QueueStupidModel15 sendMessage() Q_FULL");
		}
	}
