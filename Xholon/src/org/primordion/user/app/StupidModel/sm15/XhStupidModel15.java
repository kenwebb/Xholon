...
*/
public class XhStupidModel15 extends XholonWithPorts implements CeStupidModel15 {
	...
	public void postConfigure()
	{
		...
		case StupidModelCE:
			...
			//Random.createNormal(BugStupidModel15.initialBugSizeMean, BugStupidModel15.initialBugSizeSD);
			...
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel15 postConfigure() schedulingQ Q_FULL");
				}
