...
*/
public class AppStupidModel9 extends Application {

	public AppStupidModel9() {super();}
	
	public double getMaxConsumptionRate() {return BugStupidModel9.maxConsumptionRate;}
	public double getMaxFoodProductionRate() {return HabitatCellStupidModel9.maxFoodProductionRate;}

	public void setMaxConsumptionRate(double maxConsumptionRate)
	{
		BugStupidModel9.maxConsumptionRate = maxConsumptionRate;
	}
	
	public void setMaxFoodProductionRate(double maxFoodProductionRate)
	{
		HabitatCellStupidModel9.maxFoodProductionRate = maxFoodProductionRate;
	}
	...
	protected void step()
	{
		...
		if (XhStupidModel9.isProcessingComplete()) {
			setControllerState(IControl.CS_STOPPED);
			System.out.println("Processing is complete");
			XhStupidModel9.setProcessingComplete(false); // reset in case this app is run again
	...
	{
		if (modelNode.getXhcId() == CeStupidModel9.AggregatorCE
	...
	public static void main(String[] args) {
	    appMain(args, "org.primordion.user.app.StupidModel.AppStupidModel9",
