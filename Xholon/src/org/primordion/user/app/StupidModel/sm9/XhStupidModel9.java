...
*/
public class XhStupidModel9 extends XholonWithPorts implements CeStupidModel9 {
		...
		case StupidModelCE:
			...
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel9 postConfigure() schedulingQ Q_FULL");
				}
