...
*/
public class QueueStupidModel14 extends Queue implements IQueue {
	...
	public void act()
	{
		...
		int sz = getSize();
		if (sz == 0) {
			XhStupidModel14.setProcessingComplete(true);
		}
		for (int i = 0; i < sz; i++) {
	...
	public void sendMessage(int signal, Object data, IXholon sender)
	{
		if (enqueue(sender) == Q_FULL) {
			System.out.println("QueueStupidModel14 sendMessage() Q_FULL");
		}
	}
