...
*/
public class BugStupidModel14 extends XhStupidModel14 implements Comparable {
	...
	protected void move()
	{
		...
		Vector v = ((HabitatCellStupidModel14)parentNode).inRadius(4);
	...
	protected void reproduce()
	{
		...
		die();
		for (int i = 0; i < 5; i++) {
			BugStupidModel14 newBug = (BugStupidModel14)myParent.appendChild(myXhcName, null, myImplName);
	...
	public int compareTo(Object o) {
		...
		if (bugSize < ((BugStupidModel14)o).bugSize) {return 1;}
		else if (bugSize > ((BugStupidModel14)o).bugSize) {return -1;}
		return 0;
	}
