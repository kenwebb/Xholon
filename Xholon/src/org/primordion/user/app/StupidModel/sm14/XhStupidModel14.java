...
*/
public class XhStupidModel14 extends XholonWithPorts implements CeStupidModel14 {
	...
	public void postConfigure()
	{
		...
		case StupidModelCE:
			...
			//Random.createNormal(BugStupidModel14.initialBugSizeMean, BugStupidModel14.initialBugSizeSD);
			...
			xhParent.setMaxSize(xhParent.getNumChildren(false) * 20); // initialize the Q
			IXholon bug = xhParent.getFirstChild();
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel14 postConfigure() schedulingQ Q_FULL");
				}
