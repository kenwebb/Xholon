...
package org.primordion.user.app.StupidModel.sm14;
...
*/
public class AppStupidModel14 extends Application {

	public AppStupidModel14() {super();}
	
	public double getMaxConsumptionRate() {return BugStupidModel14.maxConsumptionRate;}
	public double getMaxFoodProductionRate() {return HabitatCellStupidModel14.maxFoodProductionRate;}
	public double getSurvivalProbability() {return BugStupidModel14.survivalProbability;}
	public double getInitialBugSizeMean() {return BugStupidModel14.initialBugSizeMean;}
	public double getInitialBugSizeSD() {return BugStupidModel14.initialBugSizeSD;}

	public void setMaxConsumptionRate(double maxConsumptionRate)
	{
		BugStupidModel14.maxConsumptionRate = maxConsumptionRate;
	}
	
	public void setMaxFoodProductionRate(double maxFoodProductionRate)
	{
		HabitatCellStupidModel14.maxFoodProductionRate = maxFoodProductionRate;
	}
	
	public void setSurvivalProbability(double survivalProbability)
	{
		BugStupidModel14.survivalProbability = survivalProbability;
	}
	
	public void setInitialBugSizeMean(double initialBugSizeMean)
	{
		BugStupidModel14.initialBugSizeMean = initialBugSizeMean;
	}
	
	public void setInitialBugSizeSD(double initialBugSizeSD)
	{
		BugStupidModel14.initialBugSizeSD = initialBugSizeSD;
	}
	...
	protected void step()
	{
		...
		if (XhStupidModel14.isProcessingComplete()) {
			setControllerState(IControl.CS_STOPPED);
			System.out.println("Processing is complete");
			XhStupidModel14.setProcessingComplete(false); // reset in case this app is run again
	...
	{
		if (modelNode.getXhcId() == CeStupidModel14.AggregatorCE
	...
	public static void main(String[] args) {
	    appMain(args, "org.primordion.user.app.StupidModel.AppStupidModel14",
