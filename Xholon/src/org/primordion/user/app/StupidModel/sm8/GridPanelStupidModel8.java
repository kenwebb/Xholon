 ...
 */
public class GridPanelStupidModel8 extends GridPanel implements IGridPanel, CeStupidModel8 {
	private static final long serialVersionUID = 1L;
	
	/**
	 * Constructor
	 */
	public GridPanelStupidModel8() {super();}
	
	/**
	 * Constructor
	 * @param gridOwner Xholon that owns the grid. */
	public GridPanelStupidModel8(IXholon gridOwner) {super(gridOwner);}
	...
	public CssColor getColor(IXholon xhNode)
	{
		...
		case BugCE:
			...
			int bugSizeRed = (int)((BugStupidModel8)xhNode).getBugSize();
