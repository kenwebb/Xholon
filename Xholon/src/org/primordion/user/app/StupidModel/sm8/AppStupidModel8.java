...
package org.primordion.user.app.StupidModel.sm8;
...
*/
public class AppStupidModel8 extends Application {

	public AppStupidModel8() {super();}
	
	public double getMaxConsumptionRate() {return BugStupidModel8.maxConsumptionRate;}
	public double getMaxFoodProductionRate() {return HabitatCellStupidModel8.maxFoodProductionRate;}

	public void setMaxConsumptionRate(double maxConsumptionRate)
	{
		BugStupidModel8.maxConsumptionRate = maxConsumptionRate;
	}
	
	public void setMaxFoodProductionRate(double maxFoodProductionRate)
	{
		HabitatCellStupidModel8.maxFoodProductionRate = maxFoodProductionRate;
	}
	...
	protected void step()
	{
		...
		if (XhStupidModel8.isProcessingComplete()) {
			setControllerState(IControl.CS_STOPPED);
			System.out.println("Processing is complete");
			XhStupidModel8.setProcessingComplete(false); // reset in case this app is run again
	...
	{
		if (modelNode.getXhcId() == CeStupidModel8.AggregatorCE
	...
	public static void main(String[] args) {
	    appMain(args, "org.primordion.user.app.StupidModel.AppStupidModel8",
