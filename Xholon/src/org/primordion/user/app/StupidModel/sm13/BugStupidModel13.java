...
*/
public class BugStupidModel13 extends XhStupidModel13 implements Comparable {
	...
	protected void move()
	{
		...
		Vector v = ((HabitatCellStupidModel13)parentNode).inRadius(4);
	...
	protected void reproduce()
	{
		...
		die();
		for (int i = 0; i < 5; i++) {
			BugStupidModel13 newBug = (BugStupidModel13)myParent.appendChild(myXhcName, null, myImplName);
	...
	public int compareTo(Object o) {
		...
		if (bugSize < ((BugStupidModel13)o).bugSize) {return 1;}
		else if (bugSize > ((BugStupidModel13)o).bugSize) {return -1;}
		return 0;
	}
