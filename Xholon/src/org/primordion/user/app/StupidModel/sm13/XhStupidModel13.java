...
*/
public class XhStupidModel13 extends XholonWithPorts implements CeStupidModel13 {
		...
		case StupidModelCE:
			...
			while (bug != null) {
				if (xhParent.enqueue(bug) == IQueue.Q_FULL) {
					System.out.println("XhStupidModel13 postConfigure() schedulingQ Q_FULL");
				}
