...
package org.primordion.user.app.StupidModel.sm4;
 ...
 */
public class GridPanelStupidModel4 extends GridPanel implements IGridPanel, CeStupidModel4 {
	private static final long serialVersionUID = 1L;
	
	/**
	 * Constructor
	 */
	public GridPanelStupidModel4() {super();}
	
	/**
	 * Constructor
	 * @param gridOwner Xholon that owns the grid. */
	public GridPanelStupidModel4(IXholon gridOwner) {super(gridOwner);}
	...
	public CssColor getColor(IXholon xhNode)
	{
		...
		case BugCE:
			...
			int bugSizeRed = (int)((BugStupidModel4)xhNode).getBugSize();
