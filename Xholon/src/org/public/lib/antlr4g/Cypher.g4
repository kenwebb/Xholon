 ...
 * 
 * KSW January 8, 2020
 * added " -> skip" and outer parentheses to Comment, and moved it to just before the fragments
 * removed Comment from WHITESPACE
 * removed two other items from WHITESPACE; they both include a LF | CR
 * 
 * later I replaced Cypher Comment with DOT COMMENT and LINE_COMMENT; this works
 * 
 * I replaced StringLiteral, and everything associated with it, with STRING from DOT, but keeping the name StringLiteral
 * For now, I can only handle double quotes but not single quotes. This is enough for my purposes.
 */
grammar Cypher;
