...
cDOMAdapter.prototype.getProperty	= function(oNode, sName) {
	...
	case "parentNode": return oNode.parent();
...
cDOMAdapter.prototype.compareDocumentPosition	= function(oNode, oNode2) {
	...
	//if (oNode2 == oNode.next()) {return 4;}
	//if (oNode2 == oNode.parent()) {return 8;}
	//if (oNode == oNode2.parent()) {return 16;}
	
	// this is DOCUMENT_POSITION_DISCONNECTED 1
	return 1;
};
