...
INSERT INTO node (id, role_name, type_id, parent_id) VALUES
 (46, 'uni', 6, 0),
 (49, 'wrld', 7, 46),
 (50, 'ocn', 8, 49),
 (151, 'isle1', 9, 50),
...
CREATE TABLE IF NOT EXISTS prop (
 ...
 prop_type varchar(20) NOT NULL, /* a valid database type? or a Java or JavaScript type? or a Xholon Attribute_ type? */
 prop_value varchar(1000) NOT NULL, /* TODO it could be an array or JS/JSON Object */
 PRIMARY KEY (node_id, prop_name),
 FOREIGN KEY (node_id) REFERENCES node(id));
INSERT INTO prop (node_id, prop_name, prop_type, prop_value) VALUES
...
INSERT INTO type (id, type_name, parent_id) VALUES
 (0, 'XholonClass', 0),
...
select role_name || ':' || type_name || '_' || node.id as name from type, node
where type.id = node.type_id
and type.type_name = 'Fisherman';
