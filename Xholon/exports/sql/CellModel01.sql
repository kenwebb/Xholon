...
Fri May 12 08:12:12 GMT-400 2017 1494591132272
...
CREATE TABLE IF NOT EXISTS Hexokinase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Glucose(8) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Glucose_6_Phosphate(9) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS PhosphoGlucoIsomerase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Glucose_6_Phosphate(9) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Fructose_6_Phosphate(10) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS PhosphoFructokinase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Fructose_6_Phosphate(10) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Fructose_1x6_Biphosphate(11) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS Aldolase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Fructose_1x6_Biphosphate(11) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Glyceraldehyde_3_Phosphate(13) */ ,
 port4 int /* FOREIGN KEY (port4) REFERENCES DihydroxyacetonePhosphate(12) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS TriosePhosphateIsomerase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES DihydroxyacetonePhosphate(12) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Glyceraldehyde_3_Phosphate(13) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS Glyceraldehyde_3_phosphateDehydrogenase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Glyceraldehyde_3_Phosphate(13) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES X1x3_BisphosphoGlycerate(14) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS PhosphoGlycerokinase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES X1x3_BisphosphoGlycerate(14) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES X3_PhosphoGlycerate(15) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS PhosphoGlyceromutase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES X3_PhosphoGlycerate(15) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES X2_PhosphoGlycerate(16) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS Enolase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES X2_PhosphoGlycerate(16) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES PhosphoEnolPyruvate(17) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS PyruvateKinase (
 ...
 pheneVal int,
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES PhosphoEnolPyruvate(17) */ ,
 port3 int /* FOREIGN KEY (port3) REFERENCES Pyruvate(18) */ ,
 PRIMARY KEY  (ID)
);
...
CREATE TABLE IF NOT EXISTS CellBilayer (
 ...
 xhcName varchar(80) NOT NULL default '',
 parentID int,
 port0 int /* FOREIGN KEY (port0) REFERENCES Glucose(2) */ ,
 port4 int /* FOREIGN KEY (port4) REFERENCES Glucose(8) */ ,
 PRIMARY KEY  (ID)
);
