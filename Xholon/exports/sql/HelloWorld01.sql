...
Sun May 21 06:53:06 GMT-400 2017 1495363986496
model: Hello World
 ...
 */
DROP TABLE IF EXISTS HelloWorldSystem;
CREATE TABLE IF NOT EXISTS HelloWorldSystem (
 ID int NOT NULL,
...
INSERT INTO HelloWorldSystem (ID, roleName, xhcID, State) VALUES
 (0, '', 1, 0);
...
CREATE TABLE IF NOT EXISTS Hello (
 ...
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES HelloWorldSystem(ID),
 FOREIGN KEY (port0) REFERENCES World(ID));
INSERT INTO Hello (ID, roleName, xhcID, State, parentID, port0) VALUES
 (2, '', 2, 0, 0, 3);
...
CREATE TABLE IF NOT EXISTS World (
 ...
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES HelloWorldSystem(ID),
 FOREIGN KEY (port0) REFERENCES Hello(ID));
INSERT INTO World (ID, roleName, xhcID, State, parentID, port0) VALUES
 (3, '', 3, 0, 0, 2);
