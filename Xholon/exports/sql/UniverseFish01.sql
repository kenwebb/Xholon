...
CREATE TABLE IF NOT EXISTS Universe (
 ...
 xhcID integer NOT NULL,
 Links varchar(80) NOT NULL default '',
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID));
INSERT INTO Universe (ID, roleName, xhcID, Links) VALUES
 (46, '', 6, '[]');
...
CREATE TABLE IF NOT EXISTS World (
 ...
 xhcID integer NOT NULL,
 Links varchar(80) NOT NULL default '',
 fprob double precision,
 parentID integer,
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES Universe(ID));
INSERT INTO World (ID, roleName, xhcID, Links, fprob, parentID) VALUES
 (49, '', 7, '[]', 0.1, 46);
...
CREATE TABLE IF NOT EXISTS Ocean (
 ...
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES World(ID));
INSERT INTO Ocean (ID, roleName, xhcID, Links, parentID) VALUES
 (50, '', 8, '[]', 49);
...
CREATE TABLE IF NOT EXISTS Island (
 ...
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES Ocean(ID));
INSERT INTO Island (ID, roleName, xhcID, Links, parentID) VALUES
 (151, '', 9, '[]', 50);
INSERT INTO Island (ID, roleName, xhcID, Links, parentID) VALUES
 (157, '', 9, '[]', 50);
...
CREATE TABLE IF NOT EXISTS Fisherman (
 ...
 PRIMARY KEY (ID),
 FOREIGN KEY (xhcID) REFERENCES XholonClass(ID),
 FOREIGN KEY (parentID) REFERENCES Island(ID));
INSERT INTO Fisherman (ID, roleName, xhcID, Links, parentID) VALUES
 (152, '', 11, '[]', 151);
INSERT INTO Fisherman (ID, roleName, xhcID, Links, parentID) VALUES
 (153, '', 11, '[]', 151);
INSERT INTO Fisherman (ID, roleName, xhcID, Links, parentID) VALUES
...
select * from XholonClass;

select xhcName from XholonClass;
select Fisherman.ID, xhcName from XholonClass, Fisherman where XholonClass.ID = Fisherman.xhcID;

select xhcName || ':' || Fisherman.ID as Name from XholonClass, Fisherman
where XholonClass.ID = Fisherman.xhcID;
