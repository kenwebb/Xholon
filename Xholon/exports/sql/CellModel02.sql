...
Sat May 13 07:30:50 GMT-400 2017 1494675050778
...
CREATE TABLE IF NOT EXISTS Hexokinase (
 ...
 port3 int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES Cytoplasm(ID),
...
CREATE TABLE IF NOT EXISTS EukaryoticCell (
 ...
 parentID int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES ExtraCellularSpace(ID));
...
CREATE TABLE IF NOT EXISTS CellBilayer (
 ...
 port4 int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES CellMembrane(ID),
 FOREIGN KEY (port0) REFERENCES Glucose(ID),
...
CREATE TABLE IF NOT EXISTS CellMembrane (
 ...
 parentID int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES EukaryoticCell(ID));
...
CREATE TABLE IF NOT EXISTS Glucose (
 ...
 parentID int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES ExtraCellularSolution(ID));
...
CREATE TABLE IF NOT EXISTS Pyruvate (
 ...
 parentID int,
 PRIMARY KEY  (ID),
 FOREIGN KEY (parentID) REFERENCES Cytosol(ID));
